...
channels.keys().forEach(channels); // $("turbolinks:load", function()
// {
...
__webpack_require__(/*! portfolio.js */ "./app/javascript/portfolio.js"); // Uncomment to copy all static images under ../images to the output folder and reference
...
/* WEBPACK VAR INJECTION */(function($) {$("turbolinks:load", function () {
  $("#AboutMe").click(function () {
    $("html,body").animate({
...
/******/ });
//# sourceMappingURL=application-8a749d10a92dcdc3bb9c.js.map